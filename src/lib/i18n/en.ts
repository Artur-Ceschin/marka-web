...
export const en = {
  ...
  auth: {
    ...
    googleStale: 'That sign-in was started somewhere else. Please try again.',
    googleMismatch: 'That sign-in response did not match this browser. Please try again.',
    googleExpiredCode: 'That sign-in link was already used. Please sign in again.',
    googleTryAgain: 'Back to sign in',
  ...
  journal: {
    title: 'Plant journal',
    subtitle: 'Every plant you have identified, newest first.',
    entryCount: (count: number) => (count === 1 ? '1 entry' : `${count} entries`),
    emptyTitle: 'Your journal is empty',
    emptyHint: 'Identify a plant and it will appear here, dated.',
  },

  profile: {
    title: 'Your profile',
    subtitle: 'Your name, a short bio and a picture.',
    photo: 'Photo',
    photoHint: 'JPEG or PNG. A square photo works best.',
    ...
    bio: 'About you',
    bioPlaceholder: 'A line or two about what you grow or look for\u2026',
    bioTooLong: (max: number) => `Keep it under ${max} characters.`,
    homeLocation: 'Home location',
    homeLocationHint:
      'Offered as a default when you identify a plant. Stored to about a kilometre.',
    pickedLocation: 'Your current location',
    pickedLocationHint: 'The place name appears once you save.',
    noLocation: 'Not set',
    ...
    uploadExpired: 'That photo upload expired. Choose the photo again.',
    email: 'Email',
    verified: 'Verified',
  ...
  plants: {
    ...
    confirmHint:
      'A close-up of a leaf or a flower works best. Whole shrubs and distant trees rarely match.',
    confirmCost: 'Identifying uses one of today\u2019s 10 tries, even if nothing is found.',
